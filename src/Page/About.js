  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flex: "space-between" }}>
        ...
        <div
          className="aboutMe"
          style={{ fontFamily: "ONE-Mobile-POP", marginBottom: "60px" }}
        >
          <p>이름 : 남유준</p>
          <p>생년월일 : 1993.12.15</p>
          <p>주소 : 인천광역시 부평구</p>
          ...
          <p>
            도전으로 인해 개발 경험의 공백이 있었지만 끈기를 가지고 바로
            프로젝트를 실행하였습니다. 비록 완벽하지 못하더라도{" "}
            <p>
          ...
          <p>
            이러한 저의 목표와 장점들을 바탕으로 여러분야의 팀원분들과 원활한
            의사소통으로 도움을 줄 수 있는 사람이 됨으로써 회사의 성장과 같이
            성장할 수
          </p>{" "}
          <p>있는 사람이 되고 싶습니다.</p>
        </div>
